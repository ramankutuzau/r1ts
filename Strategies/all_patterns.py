...
class Strategy(bt.Strategy):
    ...
    def next(self):
        ...
        stars_doji_bar.check(open=self.dataopen[0], close=self.dataclose[0], high=self.datahigh[0], low=self.datalow[0],
                             prev_open=self.dataopen[-1], prev_close=self.dataclose[-1], prev_high=self.datahigh[-1],
                             prev_low=self.datalow[-1],
                             prev2_open=self.dataopen[-2], prev2_close=self.dataclose[-2], prev2_high=self.datahigh[-2],
                             prev2_low=self.datalow[-2])
        ...
        crows_soldiers_bar.check(open=self.dataopen[0], close=self.dataclose[0], high=self.datahigh[0],
                                 ...
                                 prev2_low=self.datalow[-2])
        rails_bar.check(open=self.dataopen[0], close=self.dataclose[0], high=self.datahigh[0], low=self.datalow[0],
                        prev_open=self.dataopen[-1], prev_close=self.dataclose[-1], prev_high=self.datahigh[-1],
                        prev_low=self.datalow[-1])

        tweezers_bar.check(open=self.dataopen[0], close=self.dataclose[0], high=self.datahigh[0], low=self.datalow[0],
                           prev_open=self.dataopen[-1], prev_close=self.dataclose[-1], prev_high=self.datahigh[-1],
                           prev_low=self.datalow[-1])

        dark_veil_bar.check(open=self.dataopen[0], close=self.dataclose[0], high=self.datahigh[0], low=self.datalow[0],
                            prev_open=self.dataopen[-1], prev_close=self.dataclose[-1], prev_high=self.datahigh[-1],
                            prev_low=self.datalow[-1])
        capture_belt_bar.check(open=self.dataopen[0], close=self.dataclose[0], high=self.datahigh[0], low=self.datalow[0])
